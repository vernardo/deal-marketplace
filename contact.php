	...
	<div class="container">
		...
		<section id="contact_form">
			...
			<form method="post" action="" id="form_contacto">
				...
				<textarea name="consulta" id="consulta" rows="4" placeholder="Consulta"></textarea>
				<button type="button" form="form_contacto" name="contactar" id="contactar">Enviar</button>
			</form>
		</section>
